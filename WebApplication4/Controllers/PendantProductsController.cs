...
namespace WebApplication4.Controllers
{
    ...
    {
        private PendantProductContext db = new PendantProductContext();
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Description,PendantSize")] PendantProduct pendantProduct)
        {
            if (ModelState.IsValid)
            {
                ...
                if (pendantProduct.UploadedFile != null)
                    pendantProduct.UploadedFile.SaveAs(Path.Combine("App_Data", pendantProduct.FileName));
